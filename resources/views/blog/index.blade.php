        ...
        <div class="container ">
            <div class="page-title">
                ...
                <p class="pricing-subheadline">
                  Mai jos găsiți mai multe informații din lumea stomatologiei
                </p>
            </div>
            <ul class="blog-cards">
                ...
                <li class="blog-card">
                    ...
                    <span class="blog-card-category" data-type="1">
                        ...
                        <a href="" class="blog-card-cta link">
                            Citește
                            <span class="link-decoration black" aria-hidden="true">
                                <svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 4L9 4M9 4L5.5 0.5M9 4L5.5 7.5" stroke="white" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <li class="blog-card">
                    ...
                    <div class="blog-card-footer">
                    <span class="blog-card-category" data-type="2">
                        Igienă dentară
                    </span>
                        <a href="" class="blog-card-cta link">
                            Citește
                ...
                <li class="blog-card">
                    ...
                    <div class="blog-card-footer">
                    <span class="blog-card-category" data-type="3">
                        Chirurgie
                    </span>
                        <a href="" class="blog-card-cta link">
                            Citește
                ...
                <li class="blog-card">
                    ...
                    <div class="blog-card-footer">
                    <span class="blog-card-category" data-type="4">
                        Ortodonție
                    </span>
                        <a href="" class="blog-card-cta link">
                            Citește
            ...
            @include('components.cta-banner.cta-banner')
        </div>
    </section>
</x-layout>
